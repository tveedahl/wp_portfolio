...
reCAPTCHA in WP comments form plugin is an **ANTISPAM tool** that adds the visible Google **reCAPTCHA field** inside the comments form of your WP theme when the user is not logged in preventing fraudulent or deceptive comments.
