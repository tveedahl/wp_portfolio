...
function timveedahl_setup() {
	 ...
	 */
	load_theme_textdomain( 'timveedahl', get_template_directory() . '/languages' );
...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
		...
		array(
            ...
            'source'             => get_stylesheet_directory() . '/plugins/woocommerce.2.5.5.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'version'            => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
            //'force_activation'   => true, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            //'force_deactivation' => true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
...
if (isset($_GET['activated']) && is_admin()) {
    ...
    //$blog_page_content = '<div class="row about"><img class="img-circle pImage col-lg-offset-2" src="/spawncamping-octo-sansa/timveedahl/wp-content/uploads/sites/3/2015/12/tim_veedahl_v1.jpg" /><div class="col-lg-6"><p>I am a web developer/technologist with comprehensive client and server side programming experience. I have significant expertise regarding ecommerce, scripting, and data driven website development. Additionally, I am adept at theming and extending content management systems particularly with Magento, Wordpress, and Drupal. I am also interested in data analytics opportunities. I have completed degrees in both Information Technology with a Computer Information Systems concentration and Sociology.</p></div></div>';
    ...
    if (!isset($blog_page_check->ID) && !the_slug_exists('portfolio')) {
...
if (isset($_GET['activated']) && is_admin()) {
    $blog_page_title = 'About';
    $blog_page_content = '<div class="row about"><img class="img-circle pImage col-lg-offset-2" src="/spawncamping-octo-sansa/timveedahl/wp-content/uploads/sites/3/2016/05/timveedahl_circle_v1.jpg" /><div class="col-lg-6"><p>I am a developer with comprehensive web, mobile, and database development experience. In particular, I am adept working with technologies such as Magento, Wordpress, and Drupal. I am also knowledgeable regarding responsive design and hybrid mobile development. Additionally, I am passionate about data and the many ways it is utilized to positively impact our lives. I have completed degrees in both Information Technology with a Computer Information Systems concentration and Sociology and am seeking part-time/freelance development opportunities.</p></div></div>';
    $blog_page_check = get_page_by_title($blog_page_title);
    $blog_page = array(
        'post_type' => 'page',
        'post_title' => $blog_page_title,
