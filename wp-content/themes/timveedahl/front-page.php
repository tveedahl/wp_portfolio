...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img class="first-slide" src="<?php echo esc_url(get_template_directory_uri()); ?>/images/banner_1_v6.jpg" />
            <div class="container">
        ...
        <div class="item">
            <img class="second-slide" src="<?php echo esc_url(get_template_directory_uri()); ?>/images/banner_2_v3.jpg" />
            <div class="container">
        ...
        <div class="item">
            <img class="third-slide" src="<?php echo esc_url(get_template_directory_uri()); ?>/images/banner_3_v3.jpg" />
            <div class="container">
...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-4 text-center">
            <img class="img-circle" src="<?php echo esc_url(get_template_directory_uri()); ?>/images/front_back_circ_v1.jpg" />
        ...
        <div class="col-lg-4 text-center">
            <img class="img-circle" src="<?php echo esc_url(get_template_directory_uri()); ?>/images/mobile_circ_v1.jpg" />
            <h2>Mobile Apps</h2>
            <p>
        ...
        <div class="col-lg-4 text-center">
            <img class="img-circle" src="<?php echo esc_url(get_template_directory_uri()); ?>/images/dash_analytics_circ_v1.jpg" />
    ...
    <div class="row featurette">
        ...
        <div class="col-md-5">
            <?php
                $user = 'tveedahl';
                $token = 'dfb6426061c22f0d32d6e213d3c45ca94465c514';
